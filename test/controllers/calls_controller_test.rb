...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { call_id: @call.call_id, from: @call.from, status: @call.status, to: @call.to }
    end
  ...
  test "should update call" do
    patch :update, id: @call, call: { call_id: @call.call_id, from: @call.from, status: @call.status, to: @call.to }
    assert_redirected_to call_path(assigns(:call))
  end
